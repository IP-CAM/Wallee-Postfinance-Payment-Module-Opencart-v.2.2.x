...
class ModelExtensionWalleeSetup extends AbstractModel {
	...
	private function addEvents(){
		$this->getEventModel()->addEvent('wallee_create_dynamic_files', 'admin/controller/extension/modification/after',
	...
	private function removeEvents(){
		...
		$this->getEventModel()->deleteEvent('wallee_include_scripts');
	}
